...
This skill works best alongside the Ecology Harness stack:
- **`citation-management`** — for BibTeX cleanup and citation validation
- **`paper-lookup`** — for resolving titles, identifiers, and open-access links
- **`literature-review`** — for broader evidence synthesis after papers are tracked
- **`recent-research-scan`** — for finding newly published work to append into `PAPERS.md`
